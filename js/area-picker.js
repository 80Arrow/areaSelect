/*!
 * AreaPicker v1.0.0
 * https://github.com/80Arrow/areaSelect/
 *
 * Copyright (c) 2019 80Arrow
 *
 * Date: 2019-05-12
 */
...
(function (factory) {
    ...
    function AreaPicker(element, options) {
        this.$element = $(element);
        this.$dropdown = null;
        this.options = $.extend({}, AreaPicker.DEFAULTS, $.isPlainObject(options) && options);
        this.active = false;
        this.dems = [];
        this.needBlur = false;
        this.init();
    ...
    AreaPicker.setDefaults = function (options) {
        $.extend(AreaPicker.DEFAULTS, options);
    };

    // Save the other citypicker
    AreaPicker.other = $.fn.citypicker;
    ...
    $.fn.citypicker = function (option) {
        ...
        return this.each(function () {
            ...
            if (!data) {
                ...
                $this.data(NAMESPACE, (data = new AreaPicker(this, options)));
            }
    ...
    $.fn.citypicker.Constructor = AreaPicker;
    $.fn.citypicker.setDefaults = AreaPicker.setDefaults;

    // No conflict
    $.fn.citypicker.noConflict = function () {
        $.fn.citypicker = AreaPicker.other;
        return this;
    };

    $(function () {
        $('[data-toggle="area-picker"]').citypicker();
    });
});